 ...
 */
public class HuowurukuModel  implements Serializable {
	...
	public void setRukujiage(Integer rukujiage) {
	...
	public void setRukuneirong(String rukuneirong) {
		this.rukuneirong = rukuneirong;
	}
	
	/**
	 * 获取：入库内容
	 */
	public String getRukuneirong() {
		return rukuneirong;
	}
