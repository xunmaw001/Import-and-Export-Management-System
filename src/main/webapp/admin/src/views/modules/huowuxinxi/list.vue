<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('huowuxinxi','入库') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huowurukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'入库':'' }}</el-button>
                <el-button v-if="isAuth('huowuxinxi','入库') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huowurukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'入库':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huowuxinxi','入库') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huowurukuCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'入库':'' }}</el-button>
                <el-button v-if="isAuth('huowuxinxi','出货') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huowuchuhuoCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'出货':'' }}</el-button>
                <el-button v-if="isAuth('huowuxinxi','出货') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huowuchuhuoCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'出货':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huowuxinxi','出货') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huowuchuhuoCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'出货':'' }}</el-button>
    ...
    <huowuchuhuo-cross-add-or-update v-if="huowuchuhuoCrossAddOrUpdateFlag" :parent="this" ref="huowuchuhuoCrossaddOrUpdate"></huowuchuhuo-cross-add-or-update>
...
import huowuchuhuoCrossAddOrUpdate from "../huowuchuhuo/add-or-update";
export default {
  data() {
    return {
      huowuleixingOptions: [],
      ...
      huowuchuhuoCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    huowurukuCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
    ...
    huowuchuhuoCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.huowuchuhuoCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','huowuxinxi');
      this.$nextTick(() => {
      this.$refs.huowuchuhuoCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
          this.$http({
